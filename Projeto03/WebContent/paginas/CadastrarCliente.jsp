...
<head>
	...
	<title><h:outputText value="#{bundle.TIT_CadastrarCliente}"/></title>
...
<body>
	...
	<h:form id="formCadastrarCliente">  <!-- Início da página -->
		<h:panelGrid columns="3" columnClasses="col_esquerda, col_meio, col_direita" width="100%">
			...
			<h:column>
				<h:panelGrid columns="2"> <!-- Botoes de Novo e Salvar -->
					<h:commandLink id="btnNovo" action="#{ClienteMB.novo}" >  
			 		...
			 		<h:commandLink id="btnSalvar" action="#{ClienteMB.salvar}" >  
				...
				<rich:panel> <!-- Formulário para cadastrar Clientes -->				
					<f:facet name="header">
           				<h:outputText value="#{bundle.TIT_CadastrarCliente}" />
        			</f:facet>
        			<h:form id="form">
	...
	<!-- Calendário -->		<h:outputLabel value="#{bundle.LBL_Nascimento}" />
				...
				</rich:panel> <!-- Fim do formulário para cadastrar Clientes -->
			</h:column>
			<h:column />
		</h:panelGrid>
